...
<template>
  <div class="markdown-editor">
    <markdown-toolbar style="margin-bottom: 2px" @click="toolbarClick" @insert-table="insertTable" />
    <textarea ref="editor" />
  </div>
</template>
...
import { NIcon, NText, NUpload, NUploadDragger, type UploadFileInfo, type UploadInst, useDialog } from 'naive-ui';
